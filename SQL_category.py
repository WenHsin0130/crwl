...
# 設定輸入和輸出檔案的路徑
input_csv_path = os.path.join('csv', 'category_list.csv')
output_sql_path = os.path.join('SQL', 'insert_category.sql')
...
with open(input_csv_path, 'r', encoding='utf-8-sig') as csv_file:
    ...
    with open(output_sql_path, 'w', encoding='utf-8-sig') as sql_file:
        for row in csv_reader:
            ...
            # 生成單行 INSERT 語句
            sql_line = f"INSERT INTO category_list (CategoryID, Category) VALUES ('{category_id}', '{category}');\n"
